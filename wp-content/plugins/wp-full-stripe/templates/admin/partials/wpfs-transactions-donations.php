...
<form name="wpfs-search-donations" action="<?php echo $pageUrl; ?>" method="post">
    <div class="wpfs-page-controls">
        <div class="wpfs-form-search wpfs-page-controls__control wpfs-page-controls__control--w320 js-form-search">
            <input class="wpfs-form-control wpfs-form-search__input" type="text" name="<?php echo MM_WPFS_Admin_Menu::PARAM_NAME_DONATIONS_TEXT_FILTER ?>" value="<?php echo !empty( $textFilter ) ? $textFilter : "";  ?>" placeholder="<?php esc_html_e( 'Search...', 'wp-full-stripe-admin'); ?>">
        ...
        <div class="wpfs-ui wpfs-form-select wpfs-page-controls__control wpfs-page-controls__control--w200">
            <select class="js-selectmenu js-donations-mode-filter" name="<?php echo MM_WPFS_Admin_Menu::PARAM_NAME_DONATIONS_MODE_FILTER ?>" id="mode" data-selectmenu-prefix="<?php _e( "Mode: ", 'wp-full-stripe-admin' ); ?>">
...
<script type="text/template" id="wpfs-side-pane-donation-details">
    <div class="wpfs-side-pane" data-db-id="<%- id %>" data-stripe-id="<%- paymentIntentId %>">
        <div class="wpfs-side-pane__head">
            <div class="wpfs-side-pane__title"><?php _e( 'Donation details', 'wp-full-stripe-admin' ); ?></div>
        ...
        <div class="wpfs-side-pane-item">
            ...
            <div class="wpfs-side-pane-item__actions">
                ...
                <div class="wpfs-tooltip-content" data-tooltip-id="delete-donation-tooltip">
                    <div class="wpfs-info-tooltip"><?php _e( 'Delete donation', 'wp-full-stripe-admin' ); ?></div>
                </div>
            </div>
        </div>
        <div class="wpfs-side-pane-list">
            <div class="wpfs-side-pane-list__title"><?php _e( 'Donation', 'wp-full-stripe-admin' ); ?></div>
            <ul class="wpfs-side-pane-list__list">
                <li class="wpfs-side-pane-list__item">
                    <?php _e( 'Donation id:', 'wp-full-stripe-admin' ); ?> <a class="wpfs-btn wpfs-btn-link" href="<%- paymentIntentUrl %>" target="_blank"><%- paymentIntentId %></a>
                </li>
                <% if ( subscriptionId != null ) { %>
                <li class="wpfs-side-pane-list__item">
                    <?php _e( 'Recurring id:', 'wp-full-stripe-admin' ); ?> <a class="wpfs-btn wpfs-btn-link" href="<%- subscriptionUrl %>" target="_blank"><%- subscriptionId %></a>
                </li>
                <% } %>
                <li class="wpfs-side-pane-list__item">
                ...
                <li class="wpfs-side-pane-list__item">
                    <?php _e( 'Status:', 'wp-full-stripe-admin' ); ?> <span class="wpfs-side-pane-list__highlight"><%- localizedDonationStatus %></span>
                </li>
                <li class="wpfs-side-pane-list__item">
            ...
            <div class="wpfs-side-pane-list__title"><?php _e( 'Donor', 'wp-full-stripe-admin' ); ?></div>
            <ul class="wpfs-side-pane-list__list">
                <li class="wpfs-side-pane-list__item">
