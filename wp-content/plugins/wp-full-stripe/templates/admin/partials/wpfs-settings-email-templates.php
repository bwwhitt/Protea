...
<script type="text/template" id="wpfs-email-template">
    ...
    <div class="wpfs-form-group">
        <label for="" class="wpfs-form-label wpfs-form-label--actions">
            ...
            <?php if ( false ) { // todo: finish the "Send a test" feature ?>
                <a class="wpfs-btn wpfs-btn-link js-send-email-test" href="#"><?php esc_html_e( 'Send a test', 'wp-full-stripe-admin' ); ?></a>
            <?php } ?>
...
<script type="text/template" id="wpfs-modal-send-email-test">
    <div class="wpfs-dialog-scrollable">
        <div class="wpfs-tags-input-wrapper js-tags-input">
            <input class="wpfs-tags-input" type="text" placeholder="<?php esc_html_e('Add email addresses', 'wp-full-stripe-admin'); ?>">
        </div>
        <div class="wpfs-typo-body wpfs-typo-body--sm"><?php esc_html_e('Use space to separate emails', 'wp-full-stripe-admin'); ?></div>
    </div>
    <div class="wpfs-dialog-content-actions">
