        ...
        <div class="wpfs-form-check">
            ...
            <div class="wpfs-form-check__control">
                ...
                <div class="wpfs-form-help">
                    ...
                    <a class="wpfs-btn wpfs-btn-link" href="https://paymentsplugin.com/kb/using-placeholder-tokens" target="_blank"><?php esc_html_e( 'Learn more', 'wp-full-stripe-admin' ); ?></a>
                </div>
            </div>
        </div>
        <div class="wpfs-form-check">
