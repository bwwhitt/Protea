        ...
        <div class="wpfs-form__col">
            <div class="wpfs-inline-message wpfs-inline-message--info wpfs-inline-message--w448">
                <div class="wpfs-inline-message__inner">
                    <div class="wpfs-inline-message__title"><?php esc_html_e( 'Email notifications', 'wp-full-stripe-admin' ); ?></div>
                    <p><?php esc_html_e( 'Send customized payment receipts and reminders to your customers.', 'wp-full-stripe-admin' ); ?></p>
                    <p>
                        <a class="wpfs-btn wpfs-btn-link" href="https://paymentsplugin.com/support" target="_blank"><?php esc_html_e( 'Learn more about Email notifications', 'wp-full-stripe-admin' ); ?></a>
                    </p>
                </div>
            </div>
        </div>
