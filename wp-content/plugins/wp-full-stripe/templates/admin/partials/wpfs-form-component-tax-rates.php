...
/** @var $data */
?>
<div class="wpfs-form-group js-tax-rates" id="tax-rates" style="<?php echo $form->vatRateType == MM_WPFS::FIELD_VALUE_TAX_RATE_NO_TAX ? 'display: none;' : '';   ?>">
    <label for="" class="wpfs-form-label"><?php esc_html_e( 'Available tax rates', 'wp-full-stripe-admin' ); ?></label>
    <div id="<?php echo MM_WPFS_Admin_PaymentFormView::FIELD_FORM_TAX_RATES_ERROR; ?>" class="wpfs-field-list" data-field-name="<?php echo MM_WPFS_Admin_PaymentFormView::FIELD_FORM_TAX_RATES_ERROR; ?>">
