...
<?php if ( MM_WPFS_Utils::isDemoMode() ): ?>
    <div class="wpfs-demo-message js-demo-message">
        ...
        <div class="wpfs-demo-message__message"><?php esc_html_e( 'WP Full Stripe is running in Demo Mode.', 'wp-full-stripe-admin' ); ?></div>
    ...
    <div id="wpfs-demo-dialog-container" class="wpfs-dialog-content wpfs-dialog-demo"
         title="<?php esc_attr_e( 'WP Full Stripe Demo Mode', 'wp-full-stripe-admin' ); ?>">
