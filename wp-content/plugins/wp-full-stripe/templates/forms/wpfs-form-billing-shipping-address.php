...
$defaultBillingCountry = empty( $form->defaultBillingCountry ) ? MM_WPFS::COUNTRY_CODE_UNITED_STATES : $form->defaultBillingCountry;
	...
	<?php if ( ! is_null( $view->billingAddressPanel() ) ): ?>
		<div id="<?php $view->billingAddressPanel()->id(); ?>">
			<div class="wpfs-form-group">
				...
				<input id="<?php $view->billingName()->id(); ?>" name="<?php $view->billingName()->name(); ?>" type="text" class="wpfs-form-control">
			</div>
            <div class="wpfs-form-group">
			...
			<div class="wpfs-form-row">
				<div class="wpfs-form-col">
					<div class="wpfs-form-group">
						...
						<input id="<?php $view->billingAddressState()->id(); ?>" name="<?php $view->billingAddressState()->name(); ?>" type="text" class="wpfs-form-control" style="<?php echo $defaultBillingCountry === MM_WPFS::COUNTRY_CODE_UNITED_STATES ? 'display: none;' : ''; ?>">
                        <div class="wpfs-ui wpfs-form-select wpfs-billing-address-state-select" style="<?php echo $defaultBillingCountry !== MM_WPFS::COUNTRY_CODE_UNITED_STATES ? 'display: none;' : ''; ?>">
	...
	<?php if ( ! is_null( $view->shippingAddressPanel() ) ): ?>
		<div id="<?php $view->shippingAddressPanel()->id(); ?>" style="display: none;">
			<div class="wpfs-form-group">
				...
				<input id="<?php $view->shippingName()->id(); ?>" name="<?php $view->shippingName()->name(); ?>" type="text" class="wpfs-form-control">
			</div>
            <div class="wpfs-form-group">
			...
			<div class="wpfs-form-row">
				<div class="wpfs-form-col">
					<div class="wpfs-form-group">
						...
						<input id="<?php $view->shippingAddressLine1()->id(); ?>" name="<?php $view->shippingAddressLine1()->name(); ?>" type="text" class="wpfs-form-control">
					</div>
				</div>
				<div class="wpfs-form-col">
					<div class="wpfs-form-group">
						<label class="wpfs-form-label" for="<?php $view->shippingAddressLine2()->id(); ?>"><?php $view->shippingAddressLine2()->label(); ?></label>
						<input id="<?php $view->shippingAddressLine2()->id(); ?>" name="<?php $view->shippingAddressLine2()->name(); ?>" type="text" class="wpfs-form-control">
					</div>
				</div>
			</div>
			<div class="wpfs-form-group">
				<label class="wpfs-form-label" for="<?php $view->shippingAddressCity()->id(); ?>"><?php $view->shippingAddressCity()->label(); ?></label>
				<input id="<?php $view->shippingAddressCity()->id(); ?>" name="<?php $view->shippingAddressCity()->name(); ?>" type="text" class="wpfs-form-control">
			</div>
			<div class="wpfs-form-row">
				<div class="wpfs-form-col">
					<div class="wpfs-form-group">
						<label class="wpfs-form-label" for="<?php $view->shippingAddressState()->id(); ?>"><?php $view->shippingAddressState()->label(); ?></label>
						<input id="<?php $view->shippingAddressState()->id(); ?>" name="<?php $view->shippingAddressState()->name(); ?>" type="text" class="wpfs-form-control" style="<?php echo $defaultBillingCountry === MM_WPFS::COUNTRY_CODE_UNITED_STATES ? 'display: none;' : ''; ?>">
                        <div class="wpfs-ui wpfs-form-select wpfs-shipping-address-state-select" style="<?php echo $defaultBillingCountry !== MM_WPFS::COUNTRY_CODE_UNITED_STATES ? 'display: none;' : ''; ?>">
				...
				<div class="wpfs-form-col">
					<div class="wpfs-form-group">
						...
						<input id="<?php $view->shippingAddressZip()->id(); ?>" name="<?php $view->shippingAddressZip()->name(); ?>" type="text" class="wpfs-form-control">
					</div>
				</div>
			</div>
		</div>
