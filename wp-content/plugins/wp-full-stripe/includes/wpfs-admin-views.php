...
class MM_WPFS_Admin_CustomerPortalView extends MM_WPFS_AdminView {
    /** @var MM_WPFS_Control */
    ...
    public function __construct() {
        ...
        $this->cancelSubscriptions = MM_WPFS_ControlUtils::createControl( $this->formHash, MM_WPFS_Admin_CustomerPortalViewConstants::FIELD_MY_ACCOUNT_CANCEL_SUBSCRIPTIONS, null, null,
            /* translators: Form field label for the 'Let subscribers cancel subscriptions' option of the form */
            __( 'Let customers cancel subscriptions?', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, MM_WPFS_Admin_CustomerPortalViewConstants::FIELD_MY_ACCOUNT_CANCEL_SUBSCRIPTIONS, null, null,
        ...
        $this->cancelSubscriptions->setOptions( $options );
        ...
        $this->updowngradeSubscriptions = MM_WPFS_ControlUtils::createControl( $this->formHash, MM_WPFS_Admin_CustomerPortalViewConstants::FIELD_MY_ACCOUNT_UPDOWNGRADE_SUBSCRIPTIONS, null, null,
            /* translators: Form field label for the 'Let subscribers upgrade/downgrade subscriptions' option of the form */
            __( 'Let customers upgrade/downgrade subscriptions?', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, MM_WPFS_Admin_CustomerPortalViewConstants::FIELD_MY_ACCOUNT_UPDOWNGRADE_SUBSCRIPTIONS, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( '0' );
        $optionAttributes = array(
            'type'      => 'radio',
        ...
        $this->updowngradeSubscriptions->setOptions( $options );


        $this->showInvoices = MM_WPFS_ControlUtils::createControl( $this->formHash, MM_WPFS_Admin_CustomerPortalViewConstants::FIELD_MY_ACCOUNT_SHOW_INVOICES, null, null,
            /* translators: Form field label for the 'Show invoices to customers?' option of the form */
            __( 'Show invoices to customers?', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, MM_WPFS_Admin_CustomerPortalViewConstants::FIELD_MY_ACCOUNT_SHOW_INVOICES, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( '0' );
        $optionAttributes = array(
            'type'      => 'radio',
        ...
        $this->showInvoices->setOptions( $options );
    }
...
class MM_WPFS_Admin_FormsOptionsView extends MM_WPFS_AdminView {
    ...
    public function __construct() {
        ...
        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, MM_WPFS_Admin_FormsOptionsViewConstants::FIELD_FORMS_OPTIONS_FILL_IN_EMAIL, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( '0' );
        $optionAttributes = array(
            'type'      => 'radio',
        ...
        $this->fillInEmailForLoggedInUsers->setOptions( $options );
    }
...
trait MM_WPFS_Admin_FormView_CouponAddon {
    ...
    protected function initCoupon() {
        $this->showCouponField = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_SHOW_COUPON_FIELD, null, null,
            __( 'Show coupon field?', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_SHOW_COUPON_FIELD, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( '0' );
        $optionAttributes = array(
            'type'      => 'radio',
        ...
        $this->showCouponField->setOptions( $options );
    }
}
...
trait MM_WPFS_Admin_FormView_TaxAddon {
    ...
    protected function initTaxRateType() {
        $this->taxRateType = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_TAX_RATE_TYPE, null, null,
            __( 'Tax type', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_TAX_RATE_TYPE, null, null,
    ...
    protected function initCollectCustomerTaxId() {
        $this->collectCustomerTaxId = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_COLLECT_CUSTOMER_TAX_ID, null, null,
        ...
        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_COLLECT_CUSTOMER_TAX_ID, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( 0 );
        $optionAttributes = array(
            'type'      => 'radio',
...
class MM_WPFS_Admin_FormView extends MM_WPFS_AdminView implements MM_WPFS_Admin_FormViewConstants {
    ...
    protected function createOptionalFormFields() {
        $this->collectBillingAddress = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_COLLECT_BILLING_ADDRESS, null, null,
            __( 'Collect billing address?', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_COLLECT_BILLING_ADDRESS, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( '0' );
        $optionAttributes = array(
            'type'      => 'radio',
        ...
        $this->collectBillingAddress->setOptions( $options );
        ...
        $this->collectShippingAddress = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_COLLECT_SHIPPING_ADDRESS, null, null,
            __( 'Collect shipping address?', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_COLLECT_SHIPPING_ADDRESS, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( '0' );
        $optionAttributes = array(
            'type'      => 'radio',
        ...
        $this->collectShippingAddress->setOptions( $options );


        $this->showTermsOfService = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_SHOW_TERMS_OF_SERVICE, null, null,
            __( 'Show terms of service checkbox?', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_SHOW_TERMS_OF_SERVICE, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( '0' );
        $optionAttributes = array(
            'type'      => 'radio',
        ...
        $this->showTermsOfService->setOptions( $options );
...
class MM_WPFS_Admin_DonationFormView extends MM_WPFS_Admin_FormView implements MM_WPFS_Admin_DonationFormViewConstants {
    /** @var MM_WPFS_Control */
    protected $transactionDescription;
    /** @var MM_WPFS_Control */
    protected $currency;
    ...
    protected function initFields() {
        ...
        $this->addAmountButton = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_ADD_AMOUNT, null, null,
            ...
            __( 'Add amount', 'wp-full-stripe-admin' ), null );
...
class MM_WPFS_Admin_PaymentFormView extends MM_WPFS_Admin_FormView implements MM_WPFS_Admin_PaymentFormViewConstants {
    ...
    protected function initGenerateInvoice() {
        $this->generateInvoice = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_GENERATE_INVOICE, null, null,
            __( 'Generate invoice', 'wp-full-stripe-admin' ), null );

        $optionIndex = 0;
        $options = array();

        $option = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_GENERATE_INVOICE, null, null,
            __( 'No', 'wp-full-stripe-admin' ), $optionIndex );
        $option->setValue( '0' );
        $optionAttributes = array(
            'type'      => 'radio',
    ...
    protected function initProductSelectorStyle() {
        ...
        $listOption = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_PRODUCT_SELECTOR_STYLE, null, null,
            ...
            __( 'List of products', 'wp-full-stripe-admin' ), $optionIndex );
        $listOption->setValue( MM_WPFS::AMOUNT_SELECTOR_STYLE_RADIO_BUTTONS );
        ...
        $dropdownOption->setValue( MM_WPFS::AMOUNT_SELECTOR_STYLE_DROPDOWN );
        ...
        $buttonGroupOption->setValue( MM_WPFS::AMOUNT_SELECTOR_STYLE_BUTTON_GROUP );
    ...
    protected function initFields() {
        ...
        $this->taxRates = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_TAX_RATES, null, null,
    ...
    public static function getFields() {
        $fields = array(
            ...
            self::FIELD_FORM_SHOW_COUPON                    => MM_WPFS_ControlUtils::input( self::FIELD_FORM_SHOW_COUPON ),
            self::FIELD_FORM_ONETIME_PRODUCTS_ERROR         => MM_WPFS_ControlUtils::products( self::FIELD_FORM_ONETIME_PRODUCTS_ERROR ),
            self::FIELD_FORM_TAX_RATE_TYPE                  => MM_WPFS_ControlUtils::input( self::FIELD_FORM_TAX_RATE_TYPE ),
            self::FIELD_FORM_COLLECT_CUSTOMER_TAX_ID        => MM_WPFS_ControlUtils::input( self::FIELD_FORM_COLLECT_CUSTOMER_TAX_ID ),
            self::FIELD_FORM_TAX_RATES_ERROR                => MM_WPFS_ControlUtils::products( self::FIELD_FORM_TAX_RATES_ERROR ),
        );
...
class MM_WPFS_Admin_SubscriptionFormView extends MM_WPFS_Admin_FormView implements MM_WPFS_Admin_SubscriptionFormViewConstants {
    ...
    protected function initFields() {
        ...
        $this->subscriptionMaximumQuantity = MM_WPFS_ControlUtils::createControl( $this->formHash, self::FIELD_FORM_SUBSCRIPTION_MAXIMUM_QUANTITY, null, null,
            __( 'Maximum plan quantity', 'wp-full-stripe-admin' ), null );
        $this->subscriptionMaximumQuantity->setAttributes( array(
            'type'      => 'text',
            'class'     => 'wpfs-form-control wpfs-form-control--w120 wpfs-form-control--sm'
        ));
    ...
    public static function getFields() {
        $fields = array(
            ...
            self::FIELD_FORM_SUBSCRIPTION_MAXIMUM_QUANTITY    => MM_WPFS_ControlUtils::input( self::FIELD_FORM_SUBSCRIPTION_MAXIMUM_QUANTITY ),
