 ...
 * @property null|string|\StripeWPFS\BalanceTransaction $balance_transaction Balance transaction that describes the impact on your account balance.
 * @property null|string|\StripeWPFS\Charge $charge ID of the charge that was refunded.
 ...
 * @property null|string|\StripeWPFS\PaymentIntent $payment_intent ID of the PaymentIntent that was refunded.
 ...
 * @property null|string|\StripeWPFS\TransferReversal $source_transfer_reversal The transfer reversal that is associated with the refund. Only present if the charge came from another Stripe account. See the Connect documentation for details.
 ...
 * @property null|string|\StripeWPFS\TransferReversal $transfer_reversal If the accompanying transfer was reversed, the transfer reversal object. Only applicable if the charge was created using the destination parameter.
 */
