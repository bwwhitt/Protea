...
namespace StripeWPFS\Reporting;
 ...
 * @property \StripeWPFS\StripeObject $parameters
 ...
 * @property null|\StripeWPFS\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \StripeWPFS\ApiResource
{
