 ...
 * @property null|string|\StripeWPFS\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\StripeWPFS\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\StripeWPFS\StripeObject $shipping Where and how the card will be shipped.
 * @property \StripeWPFS\StripeObject $spending_controls
