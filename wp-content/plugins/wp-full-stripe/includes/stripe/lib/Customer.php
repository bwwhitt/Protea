 ...
 * @property null|\StripeWPFS\StripeObject $address The customer's address.
 ...
 * @property null|string|\StripeWPFS\Account|\StripeWPFS\AlipayAccount|\StripeWPFS\BankAccount|\StripeWPFS\BitcoinReceiver|\StripeWPFS\Card|\StripeWPFS\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\StripeWPFS\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property null|\StripeWPFS\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
