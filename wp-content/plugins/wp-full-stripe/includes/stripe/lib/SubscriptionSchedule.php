 ...
 * @property null|\StripeWPFS\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\StripeWPFS\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \StripeWPFS\StripeObject $default_settings
 ...
 * @property \StripeWPFS\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\StripeWPFS\Subscription $subscription ID of the subscription managed by the subscription schedule.
 */
