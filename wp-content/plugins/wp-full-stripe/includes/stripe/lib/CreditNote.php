 ...
 * @property string|\StripeWPFS\Customer $customer ID of the customer.
 * @property null|string|\StripeWPFS\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \StripeWPFS\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\StripeWPFS\Invoice $invoice ID of the invoice.
 * @property \StripeWPFS\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\StripeWPFS\Refund $refund Refund related to this credit note.
 ...
 * @property \StripeWPFS\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \StripeWPFS\CreditNote the previewed credit note
     */
     ...
     * @throws \StripeWPFS\Exception\ApiErrorException if the request fails
     *
     * @return \StripeWPFS\Collection the list of credit note line items
     */
