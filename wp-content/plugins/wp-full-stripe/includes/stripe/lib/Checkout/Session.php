 ...
 * @property null|string|\StripeWPFS\Customer $customer The ID of the customer for this session. For Checkout Sessions in <code>payment</code> or <code>subscription</code> mode, Checkout will create a new customer object based on information provided during the session unless an existing customer was provided when the session was created.
 ...
 * @property \StripeWPFS\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\StripeWPFS\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\StripeWPFS\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\StripeWPFS\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\StripeWPFS\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\StripeWPFS\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\StripeWPFS\StripeObject $total_details Tax and discount details for the computed total amount.
 */
class Session extends \StripeWPFS\ApiResource
{
    const OBJECT_NAME = 'checkout.session';

    use \StripeWPFS\ApiOperations\All;
    use \StripeWPFS\ApiOperations\Create;
    use \StripeWPFS\ApiOperations\NestedResource;
     ...
     *
     * @return \StripeWPFS\Collection the list of items
     */
