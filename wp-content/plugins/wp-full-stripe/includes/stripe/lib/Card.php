 ...
 * @property null|string|\StripeWPFS\Account $account The account this card belongs to. This attribute will not be in the card object if the card belongs to a customer or recipient instead.
 ...
 * @property null|string|\StripeWPFS\Customer $customer The customer that this card belongs to. This attribute will not be in the card object if the card belongs to an account or recipient instead.
 ...
 * @property null|string|\StripeWPFS\Recipient $recipient The recipient that this card belongs to. This attribute will not be in the card object if the card belongs to a customer or account instead.
...
class Card extends ApiResource
{
     ...
     *
     * @throws \StripeWPFS\Exception\BadMethodCallException
     */
