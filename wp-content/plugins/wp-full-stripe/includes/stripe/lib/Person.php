 ...
 * @property null|\StripeWPFS\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\StripeWPFS\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \StripeWPFS\StripeObject $dob
 ...
 * @property \StripeWPFS\StripeObject $relationship
 * @property null|\StripeWPFS\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \StripeWPFS\StripeObject $verification
 */
