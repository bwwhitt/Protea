 ...
 * @property null|string|\StripeWPFS\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\StripeWPFS\Customer $customer The ID of the customer that the bank account is associated with.
