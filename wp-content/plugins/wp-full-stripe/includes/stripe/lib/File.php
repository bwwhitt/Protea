 ...
 * @property null|\StripeWPFS\Collection $links A list of <a href="https://stripe.com/docs/api#file_links">file links</a> that point at this file.
...
class File extends ApiResource
{
     ...
     *
     * @return \StripeWPFS\File the created file
     */
    public static function create($params = null, $opts = null)
    {
        $opts = \StripeWPFS\Util\RequestOptions::parse($opts);
        if (null === $opts->apiBase) {
            $opts->apiBase = StripeWPFS::$apiUploadBase;
        }
