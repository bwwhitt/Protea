...
## 7.25.0 - 2020-02-14
* [#879](https://github.com/stripe/stripe-php/pull/879) Make `\StripeWPFS\Collection` implement `\Countable`
...
-   Use `\StripeWPFS\<class>::class` constant instead of strings ([#643](https://github.com/stripe/stripe-php/pull/643))
...
-   [#539](https://github.com/stripe/stripe-php/pull/539) Fix methods on `\StripeWPFS\PaymentIntent` to properly pass arguments to the API.

## 6.19.4 - 2018-10-11

-   [#534](https://github.com/stripe/stripe-php/pull/534) Fix PSR-4 autoloading for `\StripeWPFS\FileUpload` class alias

## 6.19.3 - 2018-10-09

-   [#530](https://github.com/stripe/stripe-php/pull/530) Add constants for `flow` (`FLOW_*`), `status` (`STATUS_*`) and `usage` (`USAGE_*`) on `\StripeWPFS\Source`
...
-   [#520](https://github.com/stripe/stripe-php/pull/520) Rename `\StripeWPFS\FileUpload` to `\StripeWPFS\File`
...
-   [#502](https://github.com/stripe/stripe-php/pull/502) Add `isDeleted()` method to `\StripeWPFS\StripeObject`

## 6.12.0 - 2018-07-28

-   [#501](https://github.com/stripe/stripe-php/pull/501) Add support for scheduled query runs (`\StripeWPFS\Sigma\ScheduledQueryRun`) for Sigma
...
-   [#498](https://github.com/stripe/stripe-php/pull/498) Internal improvements to the `\StripeWPFS\ApiResource.classUrl()` method
...
-   [#493](https://github.com/stripe/stripe-php/pull/493) Add PHPDoc for `auto_advance` on `\StripeWPFS\Invoice`

## 6.10.0 - 2018-06-28

-   [#488](https://github.com/stripe/stripe-php/pull/488) Add support for `$appPartnerId` to `StripeWPFS::setAppInfo()`
...
-   [#481](https://github.com/stripe/stripe-php/pull/481) Add new `\StripeWPFS\Discount` and `\StripeWPFS\OrderItem` classes, add more PHPDoc describing object attributes
...
-   [#479](https://github.com/stripe/stripe-php/pull/479) Fix unnecessary traits on `\StripeWPFS\InvoiceLineItem`

## 6.7.2 - 2018-05-28

-   [#471](https://github.com/stripe/stripe-php/pull/471) Add `OBJECT_NAME` constant to all API resource classes, add `\StripeWPFS\InvoiceLineItem` class
...
-   [#458](https://github.com/stripe/stripe-php/pull/458) Add PHPDoc for `account` on `\StripeWPFS\Event`
...
-   [#453](https://github.com/stripe/stripe-php/pull/453) Add constants for `reason` (`REASON_*`) and `status` (`STATUS_*`) on `\StripeWPFS\Dispute`

## 6.3.2 - 2018-02-27

-   [#452](https://github.com/stripe/stripe-php/pull/452) Add PHPDoc for `amount_paid` and `amount_remaining` on `\StripeWPFS\Invoice`

## 6.3.1 - 2018-02-26

-   [#443](https://github.com/stripe/stripe-php/pull/443) Add event types as constants to `\StripeWPFS\Event` class
...
-   [#442](https://github.com/stripe/stripe-php/pull/442) Fix PHPDoc for `\StripeWPFS\Error\SignatureVerification`
...
*   `\StripeWPFS\AttachedObject` no longer exists. Attributes that used to be instances of `\StripeWPFS\AttachedObject` (such as `metadata`) are now instances of `\StripeWPFS\StripeObject`.

-   Attributes that used to be PHP arrays (such as `legal_entity->additional_owners` on `\StripeWPFS\Account` instances) are now instances of `\StripeWPFS\StripeObject`, except when they are empty. `\StripeWPFS\StripeObject` has array semantics so this should not be an issue unless you are actively checking types.

*   `\StripeWPFS\Collection` now derives from `\StripeWPFS\StripeObject` rather than from `\StripeWPFS\ApiResource`.
...
-   Add `\StripeWPFS\StripeWPFS::setLogger()` to support an external PSR-3 compatible logger
...
-   Add `StripeWPFS::setAppInfo` to allow plugins to register user agent information
...
-   Allow global account ID to be set with `StripeWPFS::setAccountId()`
...
-   Rename `\StripeWPFS\Object` to `\StripeWPFS\StripeObject` (PHP 7 compatibility)
