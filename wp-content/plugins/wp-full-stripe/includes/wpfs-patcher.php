...
class MM_WPFS_Patcher {
	...
	private static function prepare_patches() {
        ...
        $set_form_display_name                                        = new MM_WPFS_SetFormDisplayName();
        $set_email_sender_address                                     = new MM_WPFS_SetEmailSenderAddress();
        $create_form_email_templates                                  = new MM_WPFS_CreateFormEmailTemplates();
        $convert_plan_selector_styles                                 = new MM_WPFS_ConvertPlanSelectorStyles();
        $set_default_tax_options                                      = new MM_WPFS_SetDefaultTaxOptions();
    ...
    public function process() {
        ...
        foreach ( $forms as $form ) {
            if (
                ...
                $form[self::KEY_EMAIL_TEMPLATES] = MM_WPFS_Mailer::createDefaultEmailTemplates( $this->formType, $form[self::KEY_SEND_EMAIL_RECEIPT] == 1 );
...
class InlineSaveCardEmailTemplateProcessor extends EmailTemplateProcessor {
    public function __construct() {
        parent::__construct( MM_WPFS::FORM_TYPE_INLINE_SAVE_CARD );
    }
...
class CheckoutSaveCardEmailTemplateProcessor extends EmailTemplateProcessor {
    public function __construct() {
        parent::__construct( MM_WPFS::FORM_TYPE_CHECKOUT_SAVE_CARD );
    }
...
class InlinePaymentEmailTemplateProcessor extends EmailTemplateProcessor {
    public function __construct() {
        parent::__construct( MM_WPFS::FORM_TYPE_INLINE_PAYMENT );
    }
...
class CheckoutPaymentEmailTemplateProcessor extends EmailTemplateProcessor {
    public function __construct() {
        parent::__construct( MM_WPFS::FORM_TYPE_CHECKOUT_PAYMENT );
    }
...
class InlineDonationEmailTemplateProcessor extends EmailTemplateProcessor {
    public function __construct() {
        parent::__construct( MM_WPFS::FORM_TYPE_INLINE_DONATION );
    }
...
class CheckoutDonationEmailTemplateProcessor extends EmailTemplateProcessor {
    public function __construct() {
        parent::__construct( MM_WPFS::FORM_TYPE_CHECKOUT_DONATION );
    }
...
class InlineSubscriptionEmailTemplateProcessor extends EmailTemplateProcessor {
    public function __construct() {
        parent::__construct( MM_WPFS::FORM_TYPE_INLINE_SUBSCRIPTION );
    }
...
class CheckoutSubscriptionEmailTemplateProcessor extends EmailTemplateProcessor {
    public function __construct() {
        parent::__construct( MM_WPFS::FORM_TYPE_CHECKOUT_SUBSCRIPTION );
    }
...
class MM_WPFS_CreateFormEmailTemplates extends MM_WPFS_Patch {
    ...
    public function apply() {
        ...
        (new InlineSaveCardEmailTemplateProcessor())->process();
        (new CheckoutSaveCardEmailTemplateProcessor())->process();
        (new InlinePaymentEmailTemplateProcessor())->process();
        (new CheckoutPaymentEmailTemplateProcessor())->process();
        (new InlineDonationEmailTemplateProcessor())->process();
        (new CheckoutDonationEmailTemplateProcessor())->process();
        (new InlineSubscriptionEmailTemplateProcessor())->process();
        (new CheckoutSubscriptionEmailTemplateProcessor())->process();
...
class MM_WPFS_SetEmailSenderAddress extends MM_WPFS_WPFSF_Patch {
    ...
    public function apply() {
        ...
        if (
            ! array_key_exists( MM_WPFS::OPTION_EMAIL_NOTIFICATION_SENDER_ADDRESS, $options ) ||
            empty( $options[ MM_WPFS::OPTION_EMAIL_NOTIFICATION_SENDER_ADDRESS ] )
        ) {
